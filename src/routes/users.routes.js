...
const { getAllUsers, pagInicio, getUserById, gelAllRoles, crearUsuario, borrarUsuario, updateUsuario, getAllProductos, gelAllTipoProducto, getProductoById, crearProducto, borrarProducto, updateProducto} = require('../controllers/user.controller');
